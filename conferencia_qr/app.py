...
# Forzar HTTPS en entornos de producción como Render
app.config['PREFERRED_URL_SCHEME'] = 'https'

EXCEL_FILE = 'asistentes.xlsx'

# =====================================================
# Detección de entorno: local o nube (Render)
# =====================================================
def get_local_ip():
    """Obtiene la IP local de la red (para pruebas locales)"""
    try:
...
def get_base_url():
    ...
    # Si estamos en Render, usar la variable de entorno con la URL pública
...
# =====================================================
# Manejo del archivo Excel (persistencia)
# =====================================================
def init_excel():
...
def leer_excel():
    ...
    # Guardar automáticamente si se añadieron columnas
    guardar_excel(df)
    return df
...
def registro_dia(conferencia_id):
    ...
    if request.method == 'POST':
        ...
        if tipo == 'entrada':
            # Verificar si la entrada está activada (solo si ya existe la fila)
...
# Control de SALIDA (masivo por conferencia)
...
# Control de ENTRADA (masivo por conferencia)
...
# Rutas para que el asistente descargue su constancia (página simple)
...
if __name__ == '__main__':
    ...
    # Si estamos en Render, usar debug=False; en local, debug=True
    debug_mode = os.environ.get('RENDER_EXTERNAL_URL') is None
